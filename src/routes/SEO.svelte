	...
	const jsonLd = {
		...
		'@graph': [
			...
			},
			{
				...
				'@id': `${SITE}/#website`,
				name: 'PDM',
				alternateName: 'People Driven Music',
				url: `${SITE}/`,
...
<svelte:head>
	<title>PDM — People Driven Music | Back artists for $1/month</title>
	<meta
		name="description"
	...
	<meta
		name="keywords"
		content="PDM, People Driven Music, music platform, support artists, fan community, direct artist support, music streaming, artist subscriptions, back artists, $1 per month music"
	/>
	<link rel="canonical" href="{SITE}/" />

	<meta property="og:site_name" content="PDM" />
	<meta property="og:title" content="PDM — People Driven Music | Back artists for $1/month" />
	<meta
	...
	<meta property="og:image:alt" content="PDM — People Driven Music" />
	<meta property="og:locale" content="en_US" />

	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content="PDM — People Driven Music | Back artists for $1/month" />
	<meta
	...
	<meta name="twitter:image:alt" content="PDM — People Driven Music" />
